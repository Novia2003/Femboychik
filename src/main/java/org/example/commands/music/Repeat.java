...
public class Repeat implements ICommand {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        boolean isRepeated = !guildMusicManager.getTrackScheduler().isRepeated();
        guildMusicManager.getTrackScheduler().setRepeated(isRepeated);
        event.reply("Repeat is now " + isRepeated).queue();
    }
}
